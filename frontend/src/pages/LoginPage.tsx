...
import { GQL_LOGIN } from "@gql/login";
...
export default function LoginPage() {
  ...
  const [mutate] = useMutation(GQL_LOGIN);
  ...
  return (
    <div data-theme="dark">
      <section className="flex items-stretch min-h-screen text-white ">
        <div
          className="relative items-center hidden w-1/2 bg-neutral bg-no-repeat bg-cover lg:flex"
          style={{
            backgroundImage:
        ...
        >
          <div
            className="absolute inset-0 z-10 items-center bg-neutral bg-no-repeat bg-cover lg:hidden"
            style={{
              backgroundImage:
                "url(https://images.unsplash.com/photo-1577495508048-b635879837f1?ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=675&q=80)"
            }}
          ...
          <div className="z-20 w-full py-6">
            ...
            <form className="w-full px-4 mx-auto sm:w-2/3 lg:px-0">
              <div className="pt-4 pb-2">
                ...
                />
                {errors.id && <p className="text-red-700">ID is required.</p>}
              </div>
              <div className="pt-4 pb-2">
                <input
                  className="block w-full p-4 text-lg bg-black rounded-sm"
              ...
              <div className="px-4 pt-4 pb-2">
                <button
                  className="block w-full p-4 text-lg uppercase bg-primary rounded-full hover:bg-secondary focus:outline-none"
